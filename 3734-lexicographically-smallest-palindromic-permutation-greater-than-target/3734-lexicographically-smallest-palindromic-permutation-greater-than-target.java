...
class Solution {
    public String lexPalindromicPermutation(String s, String target) {
        ...
        // First, try to construct the smallest possible half
        // that is >= targetHalf.
        ...
        // IMPORTANT:
        // Even if half == targetHalf, the full palindrome
        // can still be greater because of the middle/right half.
        if (result.compareTo(target) > 0) {
            return result;
        }

        // If the palindrome formed from the equal half is not
        // greater, find the next greater half.
    ...
    // Smallest permutation of available characters >= target
